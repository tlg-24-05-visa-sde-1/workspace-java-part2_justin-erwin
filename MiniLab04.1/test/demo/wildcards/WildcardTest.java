...
public class WildcardTest {
     ...
     */
    //this reads that sum accepts anything as long as it extends Number. Ask yourself if it makes IS-A sense.
    private double sum(Collection<? extends Number> values) {   //so we can pass a Collection of anything that extends Number, i.e. Double, Int, Long
        double sum = 0.0;
