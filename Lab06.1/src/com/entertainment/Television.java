...
public class Television implements Comparable<Television> {
    ...
    // STATIC NEXTED CLASSES - these are all referenced as Television. (dot) something - stays public, implicitly static b/c it's an enum
    // Outside this class (Television), DisplayType is still visible (public), but its name is now Television.DisplayType
    public enum DisplayType {
        LCD, LED, OLED, PLASMA, CRT
    }
    // Outside this class (Television), this is called Television.ChannelComparator - add static to signature
    ...
    // Outside this class (Television), this is called Television.BrandChannelComparator - add static to signature
    ...
    // MEMBER-LEVEL NAMED INNER CLASSES -  only visible to the class it's inside (Television here)
