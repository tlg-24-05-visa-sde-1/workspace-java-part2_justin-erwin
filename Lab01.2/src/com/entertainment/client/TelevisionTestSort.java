...
import com.entertainment.TvBrandComparator;
import com.entertainment.TvChannelComparator;
...
public class TelevisionTestSort {
    ...
    public static void main(String[] args) {
        ...
        tvList.sort(new TvChannelComparator());
        System.out.println("Sorted by channel");
        for (Television tv : tvList) {
          System.out.println(tv);
        }
            System.out.println();
        System.out.println("Sorted by Brand and then by channel");
        tvList.sort(new TvBrandComparator());
        for(Television tv: tvList){
            System.out.println(tv);
        }
